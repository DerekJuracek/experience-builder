/* @preserve
* @esri/arcgis-rest-portal - v3.6.0 - Apache-2.0
* Copyright (c) 2017-2023 Esri, Inc.
* Fri Jan 13 2023 14:56:23 GMT-0700 (Mountain Standard Time)
*/
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, arcgisRestRequest.request(url, __assign({ httpMethod: 'GET' }, requestOptions))];
                    case 1:
                        response = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, arcgisRestRequest.request(url, options)];
                    case 2:
                        response = _a.sent();
                        if (!response.success) {
